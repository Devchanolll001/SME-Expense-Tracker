...
export function AuthShell({
  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,1.1fr)]">
      ...
      <section className="flex min-h-screen items-center justify-center bg-[#f5f1e8] px-4 py-10 sm:px-8">
        <div className="w-full max-w-md rounded-2xl border border-[#e7ded2] bg-white p-6 shadow-[0_22px_55px_rgba(89,55,30,0.12)] sm:p-9">
